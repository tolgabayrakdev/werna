        ...
        <div className="min-h-screen grid lg:grid-cols-2">
            <div className="hidden lg:flex flex-col justify-between bg-primary p-12 text-primary-foreground">
                <div>
                    ...
                    <p className="text-primary-foreground/70 mt-2">Hesap oluşturun</p>
                </div>
                <div className="space-y-4">
                    <h2 className="text-4xl font-semibold leading-tight">
                        Yeni bir başlangıç<br />yapın
                    </h2>
                    <p className="text-primary-foreground/70 max-w-md">
                        Dakikalar içinde hesap oluşturun ve platformumuzun avantajlarından yararlanın.
                    </p>
                </div>
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <Input id="firstName" type="text" placeholder="Tolga" className="h-11" />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="lastName">Soyad</Label>
                                <Input id="lastName" type="text" placeholder="Yılmaz" className="h-11" />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <PasswordInput id="password" placeholder="En az 8 karakter" className="h-11" />
                        </div>

                        <div className="space-y-2">
                            <Label htmlFor="confirmPassword">Şifre Tekrar</Label>
                            <PasswordInput id="confirmPassword" placeholder="Şifrenizi tekrar girin" className="h-11" />
                        </div>
                        ...
                        <Button className="w-full h-11">Hesap Oluştur</Button>
                    </div>
